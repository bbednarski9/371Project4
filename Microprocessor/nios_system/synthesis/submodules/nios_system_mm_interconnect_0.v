...
// 
// Generated using ACDS version 14.0 200 at 2016.02.21.21:36:33
...
module nios_system_mm_interconnect_0 (
	...
	wire  [87:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> cpu_instruction_master_agent:rp_data
	wire   [3:0] rsp_mux_src_channel;                                                       // rsp_mux:src_channel -> cpu_instruction_master_agent:rp_channel
	...
	wire  [87:0] rsp_mux_001_src_data;                                                      // rsp_mux_001:src_data -> cpu_data_master_agent:rp_data
	wire   [3:0] rsp_mux_001_src_channel;                                                   // rsp_mux_001:src_channel -> cpu_data_master_agent:rp_channel
	...
	wire  [88:0] cpu_jtag_debug_module_agent_rf_source_data;                                // cpu_jtag_debug_module_agent:rf_source_data -> cpu_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [88:0] cpu_jtag_debug_module_agent_rsp_fifo_out_data;                             // cpu_jtag_debug_module_agent_rsp_fifo:out_data -> cpu_jtag_debug_module_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> cpu_jtag_debug_module_agent:cp_data
	...
	wire  [88:0] ledr_s1_agent_rf_source_data;                                              // LEDR_s1_agent:rf_source_data -> LEDR_s1_agent_rsp_fifo:in_data
	...
	wire  [88:0] ledr_s1_agent_rsp_fifo_out_data;                                           // LEDR_s1_agent_rsp_fifo:out_data -> LEDR_s1_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> LEDR_s1_agent:cp_data
	wire   [3:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> LEDR_s1_agent:cp_channel
	...
	wire  [87:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> jtag_uart_0_avalon_jtag_slave_agent:cp_data
	wire   [3:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> jtag_uart_0_avalon_jtag_slave_agent:cp_channel
	...
	wire  [87:0] cpu_instruction_master_agent_cp_data;                                      // cpu_instruction_master_agent:cp_data -> router:sink_data
	...
	wire  [87:0] cpu_data_master_agent_cp_data;                                             // cpu_data_master_agent:cp_data -> router_001:sink_data
	...
	wire  [87:0] cpu_jtag_debug_module_agent_rp_data;                                       // cpu_jtag_debug_module_agent:rp_data -> router_002:sink_data
	...
	wire  [87:0] ledr_s1_agent_rp_data;                                                     // LEDR_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [87:0] jtag_uart_0_avalon_jtag_slave_agent_rp_data;                               // jtag_uart_0_avalon_jtag_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [87:0] cmd_demux_001_src3_data;                                                   // cmd_demux_001:src3_data -> cmd_mux_003:sink0_data
	...
	wire  [87:0] rsp_demux_003_src0_data;                                                   // rsp_demux_003:src0_data -> rsp_mux_001:sink3_data
